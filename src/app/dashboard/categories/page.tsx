...
import { FREE_PLAN_MAX_CATEGORIES, getPlanEntitlement, isProPlan } from '@/lib/plans';
...
async function getCatalogAndCategories() {
    ...
    const categoryEntitlement = getPlanEntitlement(flatCategories, FREE_PLAN_MAX_CATEGORIES, isPro);
