...
const features = [
  {
    icon: Palette,
    title: 'تخصيص الهوية',
    description: 'حافظ على هوية علامتك التجارية مع خيارات تخصيص مرنة للشعار والغلاف.',
  ...
  },
  {
    ...
    title: 'إدارة ذكية',
    description: 'لوحة تحكم بسيطة لإدارة المنتجات، الطلبات، والإحصاءات من مكان واحد.',
  ...
  },
  {
    icon: MessageCircle,
    title: 'تكامل واتساب',
    description: 'استقبل الطلبات مباشرة على واتساب لتسهيل عملية البيع والتواصل.',
  ...
  },
  {
    icon: LinkIcon,
    title: 'رابط وQR مخصص',
    description: 'رابط ثابت لمتجرك مع QR Code جاهز للطباعة والنشر في محلك.',
  ...
  {
    icon: Smartphone,
    title: 'تجربة موبايل فائقة',
    description: 'متجرك يعمل بكفاءة وسرعة عالية على جميع أنواع الهواتف الذكية.',
  ...
  },
  {
    icon: Tags,
    title: 'عروض وتخفيضات',
    description: 'أنشئ عروضاً وخصومات جذابة لعملائك لزيادة مبيعاتك بسهولة.',
...
export default function Features() {
  return (
    <section id="features" className="py-24 sm:py-32 bg-[#041412] relative overflow-hidden">
        ...
        <ScrollAnimation animation="blur-in" duration={1}>
          <div className="text-center mb-16 sm:mb-24 space-y-6">
            <h2 className="text-3xl sm:text-4xl md:text-5xl lg:text-6xl font-black text-white leading-tight">
              مميزات <span className="text-brand-accent relative inline-block">
                متكاملة
            ...
            <p className="text-lg sm:text-xl text-white/50 max-w-2xl mx-auto leading-relaxed">
              كل الأدوات التي تحتاجها لإدارة متجرك باحترافية وسهولة تامة، مصممة خصيصاً لتلبية احتياجات التاجر المحلي.
            </p>
          </div>
        </ScrollAnimation>
          ...
          {features.map((feature, index) => (
            ...
            >
              <div className="relative group h-full">
                ...
                <div className={`h-full flex flex-col items-center text-center p-8 sm:p-10 rounded-[2.5rem] bg-white/[0.02] backdrop-blur-xl border border-white/10 ${feature.border} transition-all duration-500 shadow-lg group-hover:shadow-2xl group-hover:-translate-y-2`}>
