                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-8 max-w-6xl mx-auto">
                    {plans.map((plan, index) => (
                        <ScrollAnimation 
                            ...
                            duration={0.8}
                        >
                            <div className={`relative rounded-3xl p-8 border flex flex-col h-full transition-all duration-500 hover:shadow-2xl hover:-translate-y-2 ${plan.popular ? 'border-primary shadow-2xl scale-105 z-10 bg-primary/5' : 'border-border bg-card'}`}>
